...
# Helper to run the ii3502-lab6 Docker image on Windows environments
...
# Usage:
#   ./scripts/run-docker-windows.sh [--] [<docker-args>]
# Example:
#   ./scripts/run-docker-windows.sh
#   ./scripts/run-docker-windows.sh uv run python -m ii3502_lab6.climate_analysis --output src/main/resources/output/
